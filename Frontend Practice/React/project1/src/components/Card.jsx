  ...
  return (
    <div className="w-full h-screen bg-zinc-200 flex item-center justify-center gap-10">
      {data.map((elem, index) => (
        <div
          key={index}
          className="w-52 h-fit bg-zinc-100  rounded-md overflow-hidden"
        >
          ...
          <div className="w-full px-3 py-4">
            ...
            <button className={`mt-2 px-4 py-1 ${elem.inStock ? ' bg-blue-600' : ' bg-red-600' } text-xs rounded text-zinc-100`}>
